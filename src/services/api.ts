...
export const api = {
  ...
  previewLuoguProblemSet: (url: string, cookie: string) => invoke<ProblemSetInput>('preview_luogu_problem_set', { url, cookie }),
  getCommunityCatalog: () => invoke<CommunityCatalog>('get_community_catalog'),
  getCommunityProblemSet: (id: string) => invoke<CommunityEntry>('get_community_problem_set', { id }),
  saveCommunityProblemSet: (entry: CommunityEntry) => invoke<ProblemSet>('save_community_problem_set', { entry }),
  ...
  scheduleVp: (id: number, countdownSeconds: number) => invoke<TrainingMatch>('schedule_vp', { id, countdownSeconds }),
  ...
  deleteVpCode: (id: number, position: number) => invoke<void>('delete_vp_code', { id, position }),
